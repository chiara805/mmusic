    ...
    <div class="template__outside template__outside__accedi" v-if="this.sezione__accesso != 0">
        <div class="template__inside">
            ...
            <div style="margin: 4vh 0vh 4vh 0vh;">
                ...
                <h2>
                    Inserisci la tua mail e la tua password per scoprire un universo di canzoni.
                </h2>
            </div>
            <a>
                Non hai un account mmusic? <a style="color: #FF5400; cursor: pointer;"
        ...
        return {
            ...
            rules: [
                (value) => {
                    ...
                    return "è necessario inserire questi campi";
                },
            ],
        };
    },
